   ...
   <div class="jump">
       ...
       <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="myModalthree" style="margin-top:20px;">
         <div class="modal-dialog modal-lg" role="document">
           <div class="modal-content" style="margin-left:150px;width:500px;height:500px;padding-top:10px;">
                ...
                <div id="myCarousel" class="carousel slide" style="height:120px;">
                   ...
                   <div class="carousel-inner" style="height:50px;">
                   	<div class="item active">
                   		<img src="./images/首义路one.jpg" alt="First slide" width="100%" height="100px;">
                   	</div>
                   	<div class="item">
                   		<img src="./images/首义路two.jpg" alt="Second slide" width="100%" height="100px;">
                   	</div>
                   	<div class="item">
                   		<img src="./images/首义路three.jpg" alt="Third slide" width="100%" height="100px;">
                   	</div>
                   </div>
                   <!-- 轮播（Carousel）导航 -->
                   <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev" style="margin-left:20px;">
                ...
                <!-- Tab panes -->
                 <div class="tab-content" style="padding-top:5px;padding-left:5px;padding-right:5px;text-align:left;height:220px;overflow-y:auto;">
