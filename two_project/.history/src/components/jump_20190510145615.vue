   ...
   <div class="jump">
       ...
       <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="myModalthree" style="margin-top:20px;">
         <div class="modal-dialog modal-lg" role="document">
           <div class="modal-content" style="margin-left:150px;width:500px;height:510px;padding-top:10px;">
                ...
                <!-- Tab panes -->
                 <div class="tab-content" style="padding-top:5px;padding-left:5px;padding-right:5px;text-align:left;height:200px;">
               ...
               <!--备用方案-->
                ...
                <div  class="btn_close" style="margin-bottom:10px;margin-top:20px;border-top:1px solid rgb(229, 229, 229);padding-top:10px;position">
