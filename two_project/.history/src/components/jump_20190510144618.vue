   ...
   <div class="jump">
       ...
       <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="myModalthree" style="margin-top:100px;">
         <div class="modal-dialog modal-lg" role="document">
           <div class="modal-content" style="margin-left:150px;width:500px;height:450px;">
                ...
                <!--轮播图-->
                <div id="myCarousel" class="carousel slide" style="height:120px;">
                   <!-- 轮播（Carousel）指标 -->
                   <ol class="carousel-indicators" style="border:1px solid red;">
