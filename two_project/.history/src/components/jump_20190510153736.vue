                ...
                <div id="myCarousel" class="carousel slide" style="height:120px;width:100%;">
                   ...
                   <div class="carousel-inner" style="height:120px;">
                   	<div class="item active">
                   		<img src="./images/首义路one.jpg" alt="First slide" width="100%" height="120px;">
                   	</div>
                   	<div class="item">
                   		<img src="./images/首义路two.jpg" alt="Second slide" width="100%" height="120px;">
                   	</div>
                   	<div class="item">
                   		<img src="./images/首义路three.jpg" alt="Third slide" width="100%" height="120px;">
                   	</div>
                   </div>
                   <!-- 轮播（Carousel）导航 -->
