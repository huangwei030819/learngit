       ...
       <div class="header_center">
           ...
           <div class="div_nav">
              <ul class="nav nav-pills">
               ...
               <li role="presentation" style="margin-left:10px;padding-top:10px;"><router-link to='/test' class="lis" @click="page_nav(0)">周边信息</router-link></li>
               <li role="presentation" style="margin-left:10px;padding-top:10px;"><router-link to='/map_data' class="lis" @click="page_nav(0)">政策解读</router-link></li>
