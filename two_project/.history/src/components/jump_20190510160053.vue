         ...
         <div class="modal-dialog modal-lg" role="document">
           <div class="modal-content" style="margin-left:150px;width:500px;height:500px;padding-top:10px;">
                ...
                <div id="myCarousel" class="carousel slide" style="height:180px;width:100%;">
                   ...
                   <!-- 轮播（Carousel）导航 -->
                   <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev" style="border:1px solid red;margin-left:-60%;height:180px;width:40px;margin-top:-100px;">
