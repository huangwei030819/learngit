       ...
       <div class="header_center">
           ...
           <div class="div_nav">
              <ul class="nav nav-pills">
               <li role="presentation" class="" style="margin-left:10px;padding-top:10px;"><router-link to='/jump' class="lis" @click="page_nav(0)">首页</router-link></li>
               <li role="presentation" style="margin-left:10px;padding-top:10px;"><router-link to='/test' class="lis" @click="page_nav(1)">周边信息</router-link></li>
               <li role="presentation" style="margin-left:10px;padding-top:10px;"><router-link to='/map_data' class="lis" @click="page_nav(2)">政策解读</router-link></li>
