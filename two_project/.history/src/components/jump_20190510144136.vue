<template>
   <div class="jump">
       ...
       <!-- 模态框two 周边信息  示例-->
       <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="myModalthree" style="margin-top:100px;">
         <div class="modal-dialog modal-lg" role="document">
           <div class="modal-content" style="margin-left:150px;width:500px;height:400px;">
                ...
                <!--轮播图-->
                <div id="myCarousel" class="carousel slide" style="height:80px;">
                   <!-- 轮播（Carousel）指标 -->
                   <ol class="carousel-indicators" style="margin-left:0px;width:100%;height:60px;border:1px solid red;">
                   	<li data-target="#myCarousel" data-slide-to="0" class="active" style="width:100"></li>
                   ...
                   <!-- <div class="carousel-inner" style="height:80px;">
                   	<div class="item active">
                   		<img src="images/首义路one.jpg" alt="First slide" width="100%" height="50px;">
                   	</div>
                   	<div class="item">
                   		<img src="images/首义路two.jpg" alt="Second slide" width="100%" height="50px;">
                   	</div>
                   	<div class="item">
                   		<img src="images/首义路three.jpg" alt="Third slide" width="100%" height="50px;">
                   	</div>
                   </div> -->
                   <!-- 轮播（Carousel）导航 -->
                ...
                <!-- Tab panes -->
                 <div class="tab-content" style="padding-top:5px;padding-left:5px;padding-right:5px;text-align:left;">
               ...
               <!--备用方案-->
                ...
                <div style="margin-bottom:10px;margin-top:20px;border-top:1px solid rgb(229, 229, 229);padding-top:10px;">
